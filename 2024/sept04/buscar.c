...
#define TAM 10
/* Resolver: */
/* 1. Solicitar al usuario ingresar TAM elementos en un arreglo de enteros */
/** - Solo se permiten número entre: (-100,100) */
/* 2. Solicitar al usuario un número para buscar dentro del arreglo*/
...
int main(void) {
  ...
  // Si existe: imprimir el índice, no existe: imprimir que no existe
